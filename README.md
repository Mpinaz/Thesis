...
Note the y scale is logaritmic since the dataset is unbalanced and post eruption datas would not be clearly visible, [click here](https://github.com/Mpinaz/Thesis/blob/main/Images/Figure%202%20(Number%20of%20Events%20Over%20Time).png) for a standard y scale
